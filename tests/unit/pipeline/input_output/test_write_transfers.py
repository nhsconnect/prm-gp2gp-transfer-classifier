...
def test_write_transfers_correctly_writes_all_fields():
    ...
    transfer = Transfer(
        ...
        requesting_practice=Practice(
            ...
            ccg_ods_code="11B",
            ccg_name="Test Requesting GP CCG Name",
        ),
        sending_practice=Practice(
            ...
            ccg_name="Test Sending GP CCG Name",
        ),
    ...
    expected_table = {
        ...
        "requesting_practice_ccg_name": ["Test Requesting GP CCG Name"],
        ...
        "sending_practice_ccg_name": ["Test Sending GP CCG Name"],
