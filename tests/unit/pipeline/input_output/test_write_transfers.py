...
def test_write_transfers_correctly_writes_all_fields():
    ...
    transfer = Transfer(
        ...
        requesting_practice=Practice(
            ...
            icb_ods_code="11B",
            icb_name="Test Requesting GP ICB Name",
        ),
        sending_practice=Practice(
            ...
            icb_name="Test Sending GP ICB Name",
        ),
    ...
    expected_table = {
        ...
        "requesting_practice_icb_ods_code": ["11B"],
        "requesting_practice_icb_name": ["Test Requesting GP ICB Name"],
        "sending_practice_asid": ["456"],
        "sending_practice_ods_code": ["B12"],
        "sending_practice_name": ["Test Sending GP Practice Name"],
        "sending_practice_icb_ods_code": ["10A"],
        "sending_practice_icb_name": ["Test Sending GP ICB Name"],
