...
from gp2gp.odsportal.sources import construct_practice_metadata_from_ods_portal_response
...
def test_has_correct_generated_on_timestamp_given_time():
    ...
    actual = construct_practice_metadata_from_ods_portal_response(empty_response)
...
def test_returns_single_practice():
    ...
    actual = construct_practice_metadata_from_ods_portal_response(response_data)
...
def test_returns_unique_practices_in_practice_list():
    ...
    actual = construct_practice_metadata_from_ods_portal_response(response_data).practices
