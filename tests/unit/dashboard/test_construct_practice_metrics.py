...
def test_has_correct_ods_code_given_two_practices():
    ...
    actual = construct_practice_metrics(sla_metrics, year=A_YEAR, month=A_MONTH)
...
def test_has_correct_year_given_a_single_practice():
    ...
    actual = construct_practice_metrics(sla_metrics, 2019, A_MONTH)
...
def test_has_correct_month_given_a_single_practice():
    ...
    actual = construct_practice_metrics(sla_metrics, A_YEAR, 11)
...
def test_has_correct_requester_sla_metrics_given_two_practices():
    ...
    actual = construct_practice_metrics(sla_metrics, 2020, 1)
