...
| DATE_ANCHOR                 | ISO-8601 datetime specifying "now". If this is present, it will output monthly transfer data. Otherwise will read daily input spine data and output daily transfer data. |
